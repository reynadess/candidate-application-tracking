...
public class TrackingController {
	...
	@GetMapping("/getAllJobApplicationsInAppliedStatus")
	public  List<JobApplication> getAllJobApplicationsInAppliedStatus() {
	...
	public  List<JobApplication> getAllJobApplicationsInAppliedStatusByJobId(int jobId) {
		List<JobApplication> jobApplications = null;
